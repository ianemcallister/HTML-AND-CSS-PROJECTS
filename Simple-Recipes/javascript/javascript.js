...
// When the user clicks the recipe btton, open the modal
...
document.getElementById('contactForm').addEventListener('submit',
    function (event) {
        ...
        // that would coem before, between, and after.
        ...
        if(!firstName || !lastName || !phone || !message) {
            ...
            // if all fields are filled out properly than display thank you
